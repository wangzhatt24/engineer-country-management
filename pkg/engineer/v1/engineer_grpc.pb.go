...
const (
	...
	EngineerService_DeleteEngineerById_FullMethodName = "/engineer.v1.EngineerService/DeleteEngineerById"
)
...
type EngineerServiceClient interface {
	...
	DeleteEngineerById(ctx context.Context, in *DeleteEngineerRequest, opts ...grpc.CallOption) (*Engineer, error)
}
...
func (c *engineerServiceClient) DeleteEngineerById(ctx context.Context, in *DeleteEngineerRequest, opts ...grpc.CallOption) (*Engineer, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Engineer)
	err := c.cc.Invoke(ctx, EngineerService_DeleteEngineerById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EngineerServiceServer interface {
	...
	DeleteEngineerById(context.Context, *DeleteEngineerRequest) (*Engineer, error)
...
func (UnimplementedEngineerServiceServer) DeleteEngineerById(context.Context, *DeleteEngineerRequest) (*Engineer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteEngineerById not implemented")
}
...
func _EngineerService_DeleteEngineerById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteEngineerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EngineerServiceServer).DeleteEngineerById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EngineerService_DeleteEngineerById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EngineerServiceServer).DeleteEngineerById(ctx, req.(*DeleteEngineerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EngineerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteEngineerById",
			Handler:    _EngineerService_DeleteEngineerById_Handler,
		},
	},
